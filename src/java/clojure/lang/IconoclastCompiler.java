...
public class IconoclastCompiler implements Opcodes {
  ...
  static public abstract class HostExpr implements Expr, MaybePrimitiveExpr {
    ...
    // *
    public static void emitBoxReturn(ObjExpr objx, GeneratorAdapter gen,
        Class returnType) {
    ...
    // */
    public static void emitUnboxArg(ObjExpr objx, GeneratorAdapter gen,
        Class paramType) {
    ...
    static class Parser implements IParser {
      public Expr parse(C context, Object frm) {
        ...
        // fully.qualified.Classname or Classname that has been imported
        int line = lineDeref();
  ...
  static abstract class MethodExpr extends HostExpr {
    static void emitArgsAsArray(IPersistentVector args, ObjExpr objx,
    ...
    public static void emitTypedArgs(ObjExpr objx, GeneratorAdapter gen,
  ...
  static class StaticMethodExpr extends MethodExpr {
    ...
    public void emitIntrinsicPredicate(C context, ObjExpr objx,
  ...
  public static class IfExpr implements Expr, MaybePrimitiveExpr {
    ...
    public void doEmit(C context, ObjExpr objx, GeneratorAdapter gen,
        boolean emitUnboxed) {
  ...
  static class InvokeExpr implements Expr {
    ...
    public void emitProto(C context, ObjExpr objx, GeneratorAdapter gen) {
      ...
      if (protocolOn != null) {
        MethodExpr.emitTypedArgs(objx, gen, onMethod.getParameterTypes(),
    ...
    void emitArgsAndCall(int firstArgToEmit, C context, ObjExpr objx,
        GeneratorAdapter gen) {
  ...
  public static class LetExpr implements Expr, MaybePrimitiveExpr {
    ...
    public void doEmit(C context, ObjExpr objx, GeneratorAdapter gen,
      ...
      Label end = gen.mark();
      // gen.visitLocalVariable("this", "Ljava/lang/Object;", null,
      // loopLabel, end, 0);
      for (ISeq bis = bindingInits.seq(); bis != null; bis = bis.next()) {
        BindingInit bi = (BindingInit) bis.first();
        String lname = bi.binding.name;
  ...
  public static Object load(Reader rdr, String sourcePath, String sourceName) {
    ...
    try {
      ...
      if (!(e instanceof CompilerException))
        throw new CompilerException(sourcePath, (Integer) LINE_BEFORE.deref(),
            (Integer) COLUMN_BEFORE.deref(), e);
      else
        throw (CompilerException) e;
    } finally {
      Var.popThreadBindings();
  ...
  public static class CaseExpr implements Expr, MaybePrimitiveExpr {
    ...
    static class Parser implements IParser {
      // (case* expr shift mask default map<minhash, [test then]>
      // table-type test-type skip-check?)
